<script>
	import '../app.css';
	import logo from '$lib/assets/trading-repo logo.svg';
...
<style>
	...
	:global(body) {
		...
		background-image: 
			...
			/* Layer 4: Your background image */ url(../lib/assets/repo-bg.jpg);
	...
	.logo img {
		width: 60px; /* Reduced from 150px to fit a standard navbar */
		height: 60px;
		border-radius: 50%;
		object-fit: cover;
